...
@Log
public final class MyJdbcInsertAWS {
	public static void main(String args[]) {
		...
		try (java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://db.cpoo2xn7h1cf.ap-south-1.rds.amazonaws.com:3306/db", "root",
				"root1234");) {
